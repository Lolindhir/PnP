...
You gain an additional connection from the {rule}[Background Connection list](backgrounds_connections). If choosing the Faction Member connection, you can select a major faction instead of a minor one.
...
### False Identity
You have created a second identity that includes documentation, established acquaintances, and disguises that allow you to assume that persona. You gain one connection from the {rule}[Background Connection list](backgrounds_connections). There is a risk of blowing your false identity involved, determined by your DM.
