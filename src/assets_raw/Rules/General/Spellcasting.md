...
### One Spell with a Spell Slot per Turn [none]
On a turn, you can expend only one spell slot to cast a spell. This rule means you can't, for example, cast a spell with a spell slot using the Magic action and another one using a Bonus Action on the same turn.

### Reaction and Bonus Action Triggers  [none]
...
{index}[Touch](Spell Range)
{index}[Self](Spell Range)
...
### Verbal (V) [Verbal Spell Component (V)]
...
### Somatic (S) [Somatic Spell Component (S)]
...
### Material (M) [Material Spell Component (M)]
...
{index}[Instantaneous](Spell Duration)
...
**Areas of Effect.** Some spells, such as *Thunderwave*, cover an area called an area of effect, which is defined in {rule}[Area of Effect Overview](aoe). The area determines what the spell targets. The description of a spell specifies whether it has an area of effect, which is typically one of these shapes: Cone, Cube, Cylinder, Emanation, Line, or Sphere.
...
### Saving Throws [Spell Saving Throw]
