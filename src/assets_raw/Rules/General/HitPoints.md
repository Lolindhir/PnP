...
## Healing
Hit Points can be restored by magic, such as the *Cure Wounds* spell or a Potion of Healing, or by a Night or Long Rest (see the {rule}[Resting rules](resting)).
...
### Character Demise [Character Death]
...
### Falling Unconscious
If you reach 0 Hit Points and don't die instantly, you have the Unconscious condition (see the {rule}["Conditions Overview"](condition_details)) until you regain any Hit Points, and you now face making Death Saving Throws (see below).
...
### Gaining Exhaustion [Healing from 0 HP]
If you are healed from 0 Hit Points, you may gain a level of {rule}[Exhaustion](exhaustion) in consequence of the straining experience. Make a Constitution Saving throw. The DC equals 12 plus 4 times the number of your failed Death Saves at the moment you were healed.
...
### Stabilizing a Character [Stabilize]
...
### Lose Temporary Hit Points First [none]
...
### They're Not Hit Points or Healing [none]
