...
{index}[Lightly Obscured]()
{index}[Heavily Obscured]()
...
| Heavily Obscured | {rule}[Blinded condition](condition_details) when trying to see something there | area with Darkness, heavy fog, or dense foliage      |
