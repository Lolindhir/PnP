...
The complete rules for your spellcasting are explained in the {rule}[Shaman Spellcasting](shaman_spellcasting) section. As an overview, the key features of your spellcasting are listed below:

| Key Feature            | Characteristic          |
| :--------------------- | :---------------------- |
| Spellcasting Ability   | Wisdom or Charisma      |
| Spellcasting Focus     | Druidic Focus           |
| Free Cantrip           | {spell}[Elementalism]() |
| Cantrips               | Known                   |
| Spells 1+              | Prepared                |
...
### Level 1: Speaker of Two Worlds [none]
...
- You know the *{spell}[Resistance]()* cantrip, which doesn't count against the number of Shaman cantrips you know. For you, it has a range of 30 feet, its die is a d6 instead of a d4, and you can cast it as a Bonus Action.
...
- You know the *{spell}[Shillelagh]()* cantrip, which doesn't count against the number of Shaman cantrips you know. Instead of dealing Force damage with the weapon imbued by this cantrip, you deal either Acid, Cold, Fire, Lightning, or Thunder damage (your choice).
- You know the *{spell}[Absorb Elements]()* spell to ward yourself against the harmful nature of the elements, you always have it prepared, and it doesn't count against the number of spells you can prepare each day. For you, its damage dice are d8s instead of d6s.

{index}[Warrior]()


### Level 2: Elemental Aspect [none]
...
#### Aspect Spells [none]
The connection to the Elemental Aspects grants you access to spells connected with these elements. Consult the associated lists of spells depending on your Elemental Role: {rule}[Sage Spells](shaman_spells_sage) or {rule}[Warrior Spells](shaman_spells_warrior).
...
### Level 3: Elemental Resurgence [none]
...
### Level 5: Elemental Specialization [none]
...
- For you, the die of the *{spell}[Resistance]()* spell is now a d8 instead of a d4 and you add half your Shaman level to the amount of damage reduced.
...
- Once on each of your turns when you change the damage type of the weapon imbued by your *{spell}[Shillelagh]()* spell to Acid, Cold, Fire, Lightning, or Thunder damage, the damage die is doubled.
...
- For you, the damage dice of the *{spell}[Absorb Elements]()* spell are now d10s instead of d6s.



### Level 7: Elemental Manifestation [none]
...
- **Sage:** *{spell}[Summon Elemental]()*
- **Warrior:** *{spell}[Conjure Minor Elementals]()*
...
##### Free Elemental Manifestation Level [none]
...
- For you, the die of the *{spell}[Resistance]()* spell is now a d12 instead of a d4.

**Warrior:**
- When your *{spell}[Shillelagh]()* damage die would be doubled, you instead triple it.
- The once per turn extra damage of your melee attack roll increases to 2d8.
- For you, the damage dice of the *{spell}[Absorb Elements]()* spell are now d12s instead of d6s.



### Level 18: Genie Manifestation [none]
...
#### Warrior Transformation Rules [none]
...
### Level 20: Avatar of the Elements [none]
