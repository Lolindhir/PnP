...
- {rule}[Heroic Fortitude (Defense)](maneuvers)
- {rule}[Ruthless Strike (Offense)](maneuvers)
- {rule}[Trained Body (Utility)](maneuvers) 
...
The thrill of battle drives you toward victory. During combat, you can give yourself {rule}[Heroic Inspiration](inspiration) whenever you start your turn without it.
