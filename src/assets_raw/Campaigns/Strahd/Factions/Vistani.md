...
{glossary}[Vistani](Volksgruppe Barovias, kann durch den Nebel reisen, nicht-sesshaft in der Nähe von Siedlungen)
...
{index}[Vistani](Bezeichnung)
{index}[Giorgio](Bezeichnung)
{index}[Mortu](Bezeichnung)
{index}[Rauni](Bezeichnung)
{index}[Remaniu](Bezeichnung)
{index}[Vistana](Bezeichnung)