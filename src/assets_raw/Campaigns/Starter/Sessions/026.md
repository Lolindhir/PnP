...
{index}[Großvaterbaum](Ort)
{index}[Shadowtop Cathedral](Ort)  
{index}[High Forest](Ort)
{glossary}[High Forest](Riesiger Urwald im Zentrum der Schwertküste)
{index}[Glimmerwood](Ort)  
{index}[Graypeak Mountains](Ort)  
{index}[Far Realm](Ort)  
{index}[Stadt der Rubine](Ort)  
{index}[Luskan](Ort)  
{index}[Everlund](Ort)  

{index}[Drachenkult](Fraktion)
{index}[Smaragdenklave](Fraktion)
{index}[Uhtgardt-Barbaren](Fraktion)


{index}[Harschnag](NPC)
{interaction}[](harschnag)
- Aufenthaltsort im Glimmerwood erscryed
- er ist auf der Suche nach etwas
- Aurrdan kennt nun sein aussehen und kann künftig gezielt nach ihm suchen mit Magie  
{interaction}

{index}[Hamun Kost](NPC)
{interaction}[](hamun_kost)
- Auf der Suche nach den Ruinen der Stadt der Rubine  
- Athanya verfolgt seine Spur (Progress Clock 1/4)  
{interaction}

{index}[Giftzahn](NPC)
{interaction}[](giftzahn)
- Rückzug südöstlich des High Forest  
- wird von Reidoht verfolgt  
{interaction}

{index}[Maskenmacher](NPC)
{glossary}[Maskenmacher](Meister-Handwerker der Smaragdenklave in der Shadowtop Cathedral)
